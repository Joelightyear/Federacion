package org.apache.jsp.WEB_002dINF.equipo;
...
public final class listado_jsp extends org.apache.jasper.runtime.HttpJspBase
  ...
  public void _jspService(HttpServletRequest request, HttpServletResponse response)
    ...
    try {
      ...
      out.write("\t\t\t\t<td style=\"width: 17%\">Estadio</td>\r\n");
      out.write("\t\t\t\t<td style=\"width: 17%\">Presupuesto</td>\r\n");
      out.write("\t\t\t\t<td style=\"width: 17%\">Division</td>\r\n");
      out.write("\t\t\t\t<td style=\"width: 17%\">Federacion</td>\r\n");
      out.write("\t\t\t\t");
      ...
      out.write("\t\t\t\t\t\tdata-target=\"#modal-equipo\">Registrar Equipo</button>\r\n");
      out.write("\t\t\t\t</td>\r\n");
      out.write("\t\t\t</tr>\r\n");
      out.write("\t\t</tfoot>\r\n");
      out.write("\t</table>\r\n");
      ...
      out.write("\t<div class=\"modal fade\" id=\"modal-equipo\" tabindex=\"-1\"\r\n");
      out.write("\t\trole=\"dialog\" aria-hidden=\"true\">\r\n");
      out.write("\t\t<div class=\"modal-dialog\">\r\n");
      out.write("\t\t\t<div class=\"modal-content\">\r\n");
      out.write("\t\t\t\t<form id=\"form-equipo\" method=\"post\">\r\n");
      out.write("\t\t\t\t\t<div class=\"modal-header\">\r\n");
      out.write("\t\t\t\t\t\t<button type=\"button\" class=\"close\" data-dismiss=\"modal\"\r\n");
      out.write("\t\t\t\t\t\t\taria-label=\"Close\">\r\n");
      out.write("\t\t\t\t\t\t\t<span aria-hidden=\"true\">&times;</span>\r\n");
      out.write("\t\t\t\t\t\t</button>\r\n");
      out.write("\t\t\t\t\t\t<h4 class=\"modal-title\">Información de equipos</h4>\r\n");
      out.write("\t\t\t\t\t</div>\r\n");
      out.write("\t\t\t\t\t<div class=\"modal-body\">\r\n");
      out.write("                        <label for=\"nombre\">Estadio: </label> <input id=\"estadio\" name=\"estadio\"\r\n");
      out.write("                            class=\"form-control\"> \r\n");
      out.write("                        <label for=\"nombre\">Nombre: </label> <input id=\"nombre\" name=\"nombre\"\r\n");
      out.write("                            class=\"form-control\"> \r\n");
      out.write("                        <label for=\"nombre\">Presupuesto: </label> <input id=\"presupuesto\" name=\"presupuesto\"\r\n");
      out.write("                            class=\"form-control\">          \r\n");
      out.write("                        <label for=\"posicion\">Division:\r\n");
      out.write("                        </label> <select id=\"division\" name=\"division\" \r\n");
      out.write("                        class=\"form-control\">\r\n");
      out.write("                            ");
      ...
      out.write("</select>\r\n");
      out.write("                            \r\n");
      out.write("                        <label for=\"federacion\">Federacion:\r\n");
      out.write("                        </label> <select id=\"federacion\" name=\"federacion\" class=\"form-control\">\r\n");
      out.write("                            ");
      ...
      out.write("\t\t\tconsole.log(\"Entra en editar\");\r\n");
      out.write("\t\t\t\tvar id = $(this).parents('tr').data('id');\r\n");
      out.write("\t\t\t\tvar url = 'equipos/'+id;\r\n");
      out.write("\t\t\t\t\r\n");
      out.write("\t\t\t\t$.get(url)\r\n");
      out.write("\t\t\t\t\t.done(function(equipo){\r\n");
      out.write("\t\t\t\t\t\tconsole.log (equipo);\r\n");
      out.write("\t\t\t\t\t\t$('#id').val(equipo.id);\r\n");
      out.write("\t\t\t\t\t\t$('#estadio').val(equipo.estadio);\r\n");
      out.write("\t\t\t\t\t\t$('#nombre').val(equipo.nombre);\r\n");
      out.write("\t\t\t\t\t\t$('#presupuesto').val(equipo.presupuesto);\r\n");
      out.write("\t\t\t\t\t\t$('#division').val(equipo.division);\r\n");
      out.write("\t\t\t\t\t\t$('#federacion').val(equipo.federacion);\r\n");
      out.write("\t\t\t\t\t\t$('#form-equipo .modal-title').text(\"Editando equipos...\");\r\n");
      out.write("\t\t\t\t\t\t\r\n");
      out.write("\t\t\t\t\t\t$('#modal-equipo').modal('show');\r\n");
      out.write("\t\t\t\t\t});\r\n");
      out.write("\t\t});\r\n");
      out.write("\t\t\r\n");
      out.write("\t\t\r\n");
      ...
      out.write("\t\t\t\r\n");
      out.write("\t\t\t$.ajax({\r\n");
      out.write("\t\t\t\turl : \"equipos/\"+id,\r\n");
      out.write("\t\t\t\ttype: 'DELETE',\r\n");
      out.write("\t\t\t    success: function(result) {\r\n");
      out.write("\t\t\t    \t$('tr[data-id=\"'+id+'\"]').remove();\r\n");
      out.write("\t\t\t\t\tvar ingredientes = parseInt( $('#cantidad-equipos').text() );\r\n");
      out.write("\t\t\t    \t$('#cantidad-equipos').text(ingredientes - 1);\r\n");
      out.write("\t\t\t    }\r\n");
      out.write("\t\t\t});\r\n");
      out.write("\t\t\t\r\n");
      out.write("\t\t});\r\n");
    ...
    try {
      ...
      if (_jspx_eval_c_forEach_0 != javax.servlet.jsp.tagext.Tag.SKIP_BODY) {
        do {
          ...
          out.write("</td>\r\n");
          out.write("\t\t\t\t\t<td>");
          out.write((java.lang.String) org.apache.jasper.runtime.PageContextImpl.evaluateExpression("${equipo.division}", java.lang.String.class, (PageContext)_jspx_page_context, null));
          out.write("</td>\r\n");
          out.write("\t\t\t\t\t<td>");
  ...
  private boolean _jspx_meth_c_url_0(javax.servlet.jsp.tagext.JspTag _jspx_th_c_forEach_0, PageContext _jspx_page_context, int[] _jspx_push_body_count_c_forEach_0)
    ...
    _jspx_th_c_url_0.setValue((java.lang.String) org.apache.jasper.runtime.PageContextImpl.evaluateExpression("/equipos/detalle/${equipo.id}", java.lang.String.class, (PageContext)_jspx_page_context, null));
  ...
  private boolean _jspx_meth_c_forEach_1(PageContext _jspx_page_context)
    ...
    _jspx_th_c_forEach_1.setItems((java.lang.Object) org.apache.jasper.runtime.PageContextImpl.evaluateExpression("${divisiones}", java.lang.Object.class, (PageContext)_jspx_page_context, null));
    _jspx_th_c_forEach_1.setVar("division");
    ...
    try {
      ...
      if (_jspx_eval_c_forEach_1 != javax.servlet.jsp.tagext.Tag.SKIP_BODY) {
        do {
          ...
          out.write((java.lang.String) org.apache.jasper.runtime.PageContextImpl.evaluateExpression("${division}", java.lang.String.class, (PageContext)_jspx_page_context, null));
          out.write('"');
          out.write('>');
          out.write((java.lang.String) org.apache.jasper.runtime.PageContextImpl.evaluateExpression("${division}", java.lang.String.class, (PageContext)_jspx_page_context, null));
          out.write("</option>\r\n");
  ...
  private boolean _jspx_meth_c_forEach_2(PageContext _jspx_page_context)
    ...
    _jspx_th_c_forEach_2.setItems((java.lang.Object) org.apache.jasper.runtime.PageContextImpl.evaluateExpression("${federacion}", java.lang.Object.class, (PageContext)_jspx_page_context, null));
    _jspx_th_c_forEach_2.setVar("fede");
    ...
    try {
      ...
      if (_jspx_eval_c_forEach_2 != javax.servlet.jsp.tagext.Tag.SKIP_BODY) {
        do {
          out.write("\r\n");
          out.write("                                <option value=\"");
          out.write((java.lang.String) org.apache.jasper.runtime.PageContextImpl.evaluateExpression("${fede.id}", java.lang.String.class, (PageContext)_jspx_page_context, null));
          out.write('"');
          out.write('>');
          out.write((java.lang.String) org.apache.jasper.runtime.PageContextImpl.evaluateExpression("${fede.nombre}", java.lang.String.class, (PageContext)_jspx_page_context, null));
          out.write("</option>\r\n");
          out.write("                            ");
